#include "Pedido.h"
    ...
    void Pedido::ticketCliente(){
        //despliega todos los productos del pedido usando el metodo str de cada clase
        //despliega el total de articulos en el pedido
        //'cantidad de articulos' articulos
        //despliega el total a pagar por el pedido con el metodo calculaTotalPagar de cada clase
        //Total a pagar: $'total'
